"""
Test script for NII Dataset

This script tests the NII dataset implementation with masking and preprocessing.
"""
...
from padain_synthesis.nii_dataset import (
    NiiDataset, 
    NiiDataModule, 
    denormalize_ct, 
    denormalize_mr,
    DEFAULT_NII_DATA_CONFIG
)
...
def visualize_samples():
    ...
    for i in range(min(5, len(dataset))):
        ...
        plt.tight_layout()
        plt.savefig(output_dir / f"sample_{i:02d}.png", dpi=150, bbox_inches='tight')
        plt.close()
